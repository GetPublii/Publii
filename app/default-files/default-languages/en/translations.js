module.exports = {
    ...
    editor: {
        ...
        cantSavePostWithEmptyTitle: 'You cannot save a post with empty title.',
        ...
        unableToSetSpellCheckerForLanguage: '(!) Unable to set spellchecker to use selected language - ',
        viewHelp: 'View Help',
    ...
    rendering: {
        ...
        rendering: 'Rendering...',
        renderingErrorText: 'An error occurred during rendering of your website.',
        renderingPleaseWait: 'Please wait while the rendering process is completed.',
        selectThemeBeforeCreatingPreviewMsg: 'You have to select a theme before trying to create a preview of your website. Please go to the website settings and select a theme.'
    },
    settings: {
    ...
    sync: {
        ...
        clickToChangeDeploymentMethod: 'Click to change currently used deployment method',
        configureServer: 'Configure Server',
        connectedToServer: 'Connected to the server',
        connectingToServer: 'Connecting to the server...',
        connectionToServerErrorAdditionalMessage: 'An error occurred during connecting to the server: ',
        connectionToServerErrorMessage: 'An error occurred during connecting to the server. Please check your server settings or try again.',
        connectionToServerErrorText: 'An error occurred during connecting to server...',
        ...
        connectToServerErrorMsg: 'Error! Application was unable to connect with your server.',
        connectToServerSuccessMsg: 'Success! Application was able to connect with your server.',
        deploymentMethodFtpMsg: 'FTP protocol uses an unencrypted transmission, which means any data sent over it, including your username and password, could be read by anyone who may intercept your transmission. We strongly recommend to use FTPS or SFTP protocols if possible.',
        deploymentMethodGithubPagesMsg: 'For detailed information about how to configure a website using Github Page, see online <a href="https://getpublii.com/docs/host-static-website-github-pages.html" target="_blank" rel="noopener noreferrer">documentation</a>.',
        ...
        deploymentMethodGitlabPagesMsg: 'For detailed information about how to configure a website using GitLab Pages, see online <a href="https://getpublii.com/docs/host-static-website-gitlab-pages.html" target="_blank" rel="noopener noreferrer">documentation</a>.',
        deploymentMethodGoogleCloudMsg: 'For detailed information about how to configure a website using Google Cloud, see online <a href="https://getpublii.com/docs/make-static-website-google-cloud.html" target="_blank" rel="noopener noreferrer">documentation</a>.',
        deploymentMethodNetlifyMsg: 'For detailed information about how to configure a website using Netlify, see online<a href="https://getpublii.com/docs/build-a-static-website-with-netlify.html" target="_blank" rel="noopener noreferrer">documentation</a>.',
        deploymentMethodS3Msg: 'For detailed information about how to configure a website using S3, see online <a href="https://getpublii.com/docs/setup-static-website-hosting-amazon-s3.html" target="_blank" rel="noopener noreferrer">documentation</a>.',
        ...
        deploymentSettingDoubleSlashProtocolNote: 'Note: while using "//" as protocol, some features like Open Graph tags, sharing buttons etc. cannot work properly.',
        deploymentSettingFileProtocolNote: 'The "file://" protocol is useful only if you are using manual deployment method for the intranet websites.',
        ...
        filesNotSyncedErrorMessage: 'Please check hard-upload-errors-log.txt files using the Tools -&gt; Log Viewer tool.',
        ...
        googleCloudPrefixNote: 'You can put your website in the subdirectory. Please avoid slash at the beginning (i.e. <strong>/blog/</strong>) - as it will create additional directory with the empty name. Proper prefix example: <strong>blog</strong>.',
        goToAppSettings: 'Go to app settings',
        goToSettings: 'Go to settings',
        keyFile: 'Key file',
        lastRendered: 'Last rendered',
        lastSync: 'Last sync',
        leaveBlankToUseDefaultOutputDirectory: 'Leave blank to use default output directory',
        manualDeployment: 'Manual deployment',
        manualOutputFieldCantBeEmpty: 'The manual output selection cannot be empty',
        ManualUpload: 'Manual upload',
        netlify: 'Netlify',
        netlifyToken: 'Netlify token',
        operationsDone: 'operations done',
        outputDirectory: 'Output directory',
        outputDirectoryNote: 'Selected directory content will be removed during website generating',
        outputType: 'Output type',
        outputTypeNote: 'Publii will generate a catalog or ZIP/TAR archive with your website. Then you can upload these files to any destination server manually.',
        parallelUploads: 'Parallel uploads',
        parallelUploadsNote: 'More parallel operations can lead to upload errors on slow internet connections or error 403 due API rate limits.',
        ...
        provideFTPPasswordFor: 'Please provide FTP password for ',
        provideFTPPasswordForServer: 'Please provide your FTP password for the following server: ',
        region: 'Region',
        regionFieldCantBeEmpty: 'The region selection cannot be empty',
        ...
        requireCertificateForConnection: 'Require the valid certificate for connection',
        requireFTPPassAlwaysOnSync: 'Require the FTP password on every time you sync your site',
        s3CompatibleStorage: 'S3 compatible storage',
        s3PrefixNote: 'You can put your website in the subdirectory. Please avoid slash at the beginning (i.e. <strong>/blog/</strong>) - as it will create additional directory with the empty name. Proper prefix example: <strong>blog/</strong>.',
        ...
        serverSettingsSaveSuccessMsg: 'Server settings has been successfully saved.',
        settings: ' settings',
        sftp: 'SFTP',
        ...
        syncFTPNoPassowrdMsg: 'Without password you cannot sync your website. Please try again',
        syncInProgress: 'Sync in progress',
        syncInProgressMessage: 'During sync process you cannot change site name.',
        syncYourWebsite: 'Sync your website',
        testConnection: 'Test connection',
        testConnectionNoPassowrdMsg: 'Without password you cannot test connection. Please try again',
        token: 'Token',
        ...
        useCustomS3ProviderNote: 'Note: AWS is the default S3 provider. While using an alternative provider, you need to fill the "S3 provider endpoint" field.',
        ...
        websiteSynchronizationInfo: 'Any duplicate files or filenames already existing in the destination location <br>that match the Publii-generated files will be overwritten.',
    ...
    tools: {
        ...
        logFileEmpty: 'This log file is empty...',
        logViewer: 'Log viewer',
        selectFileToLoad: 'Select file to load',
        thumbnails: {
            listRegeneratedFiles: 'List of the regenerated files:',
            processingRegenerateThumbanilsInfo: 'Pressing the Regenerate thumbnails button will start generating new image sizes defined by your new theme.',
            progress: 'Progress: ',
            ...
            themeOrThumbnailsSettingsChanged: 'Your theme or thumbnail settings has been changed.',
        ...
        wpImport: {
            ...
            duringWXRAnalyzeWeHaveFound: 'During WXR analyze we have found',
            importAuthors: 'Import authors',
            importData: 'Import data',
            importingData: 'Importing data',
            importNote: 'Posts will be imported as compatible with the WYSIWYG editor.',
            importSelectedTypesOfPosts: 'Import selected types of posts:',
            pages: 'pages',
            ...
            wpImportGoToRegenerateMsg: 'Your WordPress data has been imported. Thumbnails regeneration can be necessary if you have selected a theme before.'
        }
    },
    ui: {
        aboutPublii: 'About Publii',
