module.exports = {
    ...
    file: {
        ...
        createBackupNameInUseMsgPt1: 'Podana nazwa pliku',
        createBackupNameInUseMsgPt2: 'jest używana przez istniejący plik kopii zapasowej is used by an existing backup. Proszę spóbować ponownie, podając inną nazwę.',
        ...
        deletBackupsConfirmMsg: 'Czy na pewno chcesz usunąć wybrane kopie zapasowe? Tej czynności nie można cofnąć.',
    ...
    rendering: {
        errorDuringPreviewCreatinMsg: 'Wystąpił błąd podczas tworzenia podglądu.',
    ...
    sync: {
        accessID: 'ID dsostępu',
        accessIDFieldCantBeEmpty: 'Pole ID dostępu nie może być puste',
        acl: 'ACL',
        ...
        branchExampleGitLabeNote: 'Przykłady: <strong>docs</strong>, <strong>main</strong> lub <strong>master</strong>',
        ...
        connectToServerCantStoreFilesErrorMsg: 'Błąd! Aplikacja mogła połączyć się z Twoim serwerem, ale nie mogła przechowywać plików. Sprawdź uprawnienia do plików na swoim serwerze.',
        ...
        deploymentSettingDatHyperIpfsProtocolNote: 'Protokół "dat://", "hyper://" i "ipfs://" jest przydatny tylko wtedy, gdy planujesz korzystać ze swojej witryny w sieciach P2P. Przeczytaj więcej o <a href="https://datproject.org/" target="_blank" rel="noopener noreferrer">dat://</a>, <a href="https://hypercore-protocol.org/" target="_blank" rel="noopener noreferrer">hyper://</a> i <a href="https://ipfs.io/" target="_blank" rel="noopener noreferrer">IPFS</a>',
        ...
        deploymentSettingRelativeUrlsNote: 'Uwaga: podczas korzystania z względnych URLi, niektóre funkcje, takie jak tagi Open Graph, mapy witryn, kanały RSS, kanały JSON itp., zostaną wyłączone.',
        ...
        filesNotSyncedErrorMessage: 'Proszę sprawdzić plik hard-upload-errors-log.txt przy pomocy narzędzia Narzędzia -&gt; Podgląd dziennika.',
        filesNotSyncedErrorText: 'Niektóre pliki nie zostały poprawnie zsynchronizowane.',
        ftp: 'FTP',
        ftps: 'FTPS',
        ftpWithSSLTLS: 'FTP z SSL/TLS',
        getWebsiteFiles: 'Pobierz pliki strony internetowej',
        ...
        leaveBlankToUseDefaultOutputDirectory: 'Pozostaw puste aby użyć domyślnego kata;pgu docelowego',
        ...
        outputDirectoryNote: 'Zawartość wyranego katalogu zostanie usunięta podczas generowania strony',
        ...
        syncFTPNoPassowrdMsg: 'Bez hasła nie można zsynchronizować witryny. Proszę spróbować ponownie',
        ...
        testConnection: 'Testuj połczenie',
        testConnectionNoPassowrdMsg: 'Bez hasła nie można przetestować połączenia. Proszę spróbuj ponownie',
        token: 'Token',
        ...
        usernameOrganization: 'Nazwa użytkonika / organizacji',
        visitWebsite: 'Odwiedź stronę',
        visitYourWebsite: 'Odwiedź swoją stronę',
        websiteFilesPreparedInfo: 'Twoja strona internetowa została przygotowana. Użyj poniższego przycisku "Pobierz pliki strony internetowej" <br>aby uzyskać pliki w celu ich ręcznego wdrożenia.',
