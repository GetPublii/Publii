    ...
    setInternalLinks (posts, pages) {
        ...
        for (let i = 0; i < authorIDs.length; i++) {
            ...
            if (typeof this.renderer.cachedItems.authors[authorID].authorViewConfig === 'object') {
                ...
                this.renderer.cachedItems.authors[authorID].authorViewConfig = ContentHelper.setInternalLinksInObject(viewConfig, this.renderer);
            }
        }
        ...
        for (let i = 0; i < tagIDs.length; i++) {
            ...
            if (typeof this.renderer.cachedItems.tags[tagID].tagViewConfig === 'object') {
                ...
                this.renderer.cachedItems.tags[tagID].tagViewConfig = ContentHelper.setInternalLinksInObject(viewConfig, this.renderer);
            }
        }
    }
}
