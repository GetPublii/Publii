...
import ProgressOrb from './components/basic-elements/ProgressOrb';
...
mainProcessAPI.receive('app-data-loaded', function (initialData) {
    ...
    Vue.component('progress-orb', ProgressOrb);
    ...
    new Vue({
        ...
        async mounted () {
            ...
            window.app = {
                ...
                galleryPopupUpdated: (callback) => this.$bus.$once('gallery-popup-updated', callback),
