...
tinymce.PluginManager.add('image', function(editor) {
    ...
    function showDialog(imageList) {
        ...
        function onSubmitForm() {
            ...
            editor.undoManager.transact(function() {
                ...
                if (!imgElm) {
                    ...
                    if (dom.is(imgElm.parentNode, 'figure.post__image')) {
                        dom.setAttrib(imgElm, 'class', null);
                    }
                } else {
                ...
                if (data.caption === false) {
                    if (dom.is(imgElm.parentNode, 'figure.post__image')) {
                        ...
                        dom.setAttrib(imgElm, 'class', data['class']);
                ...
                if (data.caption === true) {
                    if (!dom.is(imgElm.parentNode, 'figure.post__image')) {
                        ...
                        figureElm = dom.create('figure', {'class': 'post__image ' + data['class'] });
                        dom.setAttrib(imgElm, 'class', null);
                        figureElm.appendChild(imgElm);
                        figureElm.appendChild(dom.create('figcaption', {contentEditable: true}, 'Put your caption here'));
                    ...
                    if(dom.is(imgElm.parentNode, 'figure.post__image')) {
                        dom.setAttrib(imgElm.parentNode, 'class', 'post__image ' + data['class']);
                    }
        ...
        figureElm = dom.getParent(imgElm, 'figure.post__image');
        if (figureElm) {
        ...
        if (imgElm) {
            ...
            className = dom.getAttrib(imgElm, 'class');

            if(imgElm.parentNode.tagName === 'FIGURE') {
                className = dom.getAttrib(imgElm.parentNode, 'class');
    ...
    editor.addButton('image', {
        ...
        stateSelector: 'img:not([data-mce-object],[data-mce-placeholder]),figure.post__image'
    });
