 ...
 *
 * Modified at 6th January 2020 (Updated at 14th April 2020): unminified and modified to use CSS classes used in Publii and wrap properly images inside the figure element.
 */
! function(s) {
    "use strict";
    ...
    var n, r = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        u = a(!1),
        c = a(!0),
        l = (n = {
            fold: function(t, e) {
    ...
    p = undefined, g = O, h = C, y = undefined,
        function(t) {
            "object" == typeof g && void 0 !== h ? h.exports = t() : "function" == typeof p && p.amd ? p([], t) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EphoxContactWrapper = t()
        }(function() {
            return function s(o, a, u) {
                ...
                for (var l = "function" == typeof y && y, t = 0; t < u.length; t++) c(u[t]);
                return c
            }({
                1: [function(t, e, n) {
                    var r, i, o = e.exports = {};
    ...
    function z(t, e) {
        // Custom modification START: added read operation of the class name from the figure wrapper
        if (e === 'class') {
            if (t.parentNode && t.parentNode.tagName === 'FIGURE') {
                var className = t.parentNode.getAttribute('class');

                if (className !== '') {
                    className = className.split(' ');
                    className = className.filter(item => item.indexOf('post__image--') > -1);

                    if (className.length > 0) {
                        return 'post__image ' + className[0];
                    }
    ...
    function B(t, e, n) {
        // Custom modification START: check for the setAttrib function to handle figure CSS class instead of img class when figure is available
        if (e === 'class' && t.tagName === 'IMG') {
            if (t.parentNode && t.parentNode.tagName === 'FIGURE') {
                t.parentNode.setAttribute(e, n);
                return;
            }
        }
        // Custom modification END
    ...
    function G(t) {
        H(t) ? function(t) {
            var e = t.parentNode;
            // Custom change: added class attribute value from figure to img
            t.setAttribute('class', e.getAttribute('class'));
            zt.insertAfter(t, e), zt.remove(e)
        }(t) : function(t) {
            var e = zt.create("figure", {
                // Custom change: changed "image" to value of the img attribute class value
                "class": t.getAttribute('class')
            });
            // Custom change: remove class attribute from image
    ...
    function rt(t) {
        var e = t.selection.getNode(),
            // Custom change: changed selector from figure.image to figure.post__image
            n = t.dom.getParent(e, "figure.post__image");
        ...
        var n = function(t, e) {
            ...
            if (Mt(t, _t(e, {
                ...
                var r = zt.create("figure", {
                    // Custom change: changed class value from "image" to img class attribute value 
    ...
    function at(t, e) {
        ...
        n ? e.src ? function(e, t) {
            ...
            if (e) {
                // Custom change: changed selector from figure.image to figure.post__image
                var n = t.dom.is(e.parentNode, "figure.post__image") ? e.parentNode : e;
    ...
    function Zt(t) {
        // Custom change: added condition for checking t.classes which removes "class" property if t.classes is empty
        if (t.classes) {
            return {
                src: t.src.value,
                alt: t.alt,
            ...
            return {
                ...
                body: function(t) {
                    return t.hasAdvTab || t.hasUploadUrl || t.hasUploadHandler ? {
                        type: "tabpanel",
                        tabs: v([
                            [Ut(t)], t.hasAdvTab ? [ae(t)] : [], t.hasUploadTab && (t.hasUploadUrl || t.hasUploadHandler) ? [ue(t)] : []
                        ])
                    } : {
                        type: "panel",
                        items: xt(t)
    ...
    var ae = function(t) {
        ...
        se = function(e) {
            e.ui.registry.addToggleButton("image", {
                ...
                onAction: ie(e).open,
                onSetup: function(t) {
                    // Custom change: changed figure.image into figure.post__image
                    return e.selection.selectorChangedWithUnbind("img:not([data-mce-object],[data-mce-placeholder]),figure.post__image", t.setActive).unbind
                }
