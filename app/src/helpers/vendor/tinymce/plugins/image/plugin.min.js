 ...
 * 
 * Modified at 18th February 2022: unminified and modified to use CSS classes used in Publii and wrap properly images inside the figure element.
 */
! function() {
    "use strict";
    ...
    function re(e) {
        var t = e.selection.getNode(),
            ...
            n = e.dom.getParent(t, "figure.post__image");
    ...
    function oe(t, e) {
        ...
        // Custom change: changed selector from figure.image to figure.post__image
        }, f.onerror = y)) : (a = t, (o = b) && (l = a.dom.is(o.parentNode, "figure.post__image") ? o.parentNode : o, a.dom.remove(l), a.focus(), a.nodeChanged(), a.dom.isEmpty(a.getBody()) && (a.setContent(""), a.selection.setCursorLocation())))) : e.src && ae(t, v(v({}, Q()), e))
    }
    ...
    function me(e, t) {
        // Custom change: added condition for checking e.classes which removes "class" property if e.classes is empty
        if (e.classes) {
            return {
                src: e.src.value,
    ...
    var ye, ve = be,
        ...
        Ce = function(e, t, n) {
            ...
            ee(n, r, t, "caption", function(e, t, n) {
                ...
                return H(r = e) ? (o = r.parentNode, r.setAttribute('class', o.getAttribute('class')), Ue.insertAfter(r, o), Ue.remove(o)) : (i = r, a = Ue.create("figure", {
                    // Custom change: changed "image" to value of the img attribute class value
                    class: r.getAttribute('class')
                // Custom change: remove class attribute from image
                }), r.removeAttribute('class'), Ue.insertAfter(a, i), a.appendChild(i), a.appendChild(Ue.create("figcaption", {
                    contentEditable: "true"
    ...
    o.add("image", function(e) {
        ...
        (t = e).on("PreInit", function() {
            ...
            onSetup: function(e) {
                ...
                return e.setActive(D(re(n))), n.selection.selectorChangedWithUnbind("img:not([data-mce-object],[data-mce-placeholder]),figure.post__image", e.setActive).unbind
            }
