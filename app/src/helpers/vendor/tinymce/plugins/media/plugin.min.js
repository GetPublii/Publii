 ...
 * 
 * Modified at 6th January 2020 (Updated at 14th April 2020): unminified and modified to use figure elements with post__video/post__audio classes
 * Modified at 8th January 2020 (Updated at 14th April 2020): disabled protocol-less URLs to videos 
 * Modified at 29th July 2020: disabled protocol-less URLs to videos - part II - improved regexps
 * 
 */
! function() {
    "use strict";
    ...
    function y(e, t) {
        ...
        for (r in t)
            if (i = "" + t[r], e.map[r])
                for (n = e.length; n--;)(o = e[n]).name === r && (i ? (e.map[r] = i, o.value = i) : (delete e.map[r], e.splice(n, 1)));
            else i && (e.push({
                name: r,
                value: i
            }), e.map[r] = i)
    ...
    function x(e, t) {
        ...
        return oe.setMaxWidth(r, t.width), oe.setMaxHeight(r, t.height),
            function(e) {
                var t = se();
    ...
    function j(r, e) {
        ...
        return n.width = n.width || "300", n.height = n.height || "150", re.each(n, function(e, t) {
            ...
            // Custom change: added <figure> element with the post__video class and added https when there is no protocol at the beginning
            return '<figure class="post__video"><iframe src="' + (e.source1.indexOf('//') === 0 ? 'https:' + e.source1 : e.source1) + '" width="' + e.width + '" height="' + e.height + '"' + t + "></iframe></figure>"
            ...
            // Custom change: added <figure> element with the post__audio class
            return t ? t(e) : '<figure class="post__audio"><audio controls="controls" src="' + e.source1 + '">' + (e.source2 ? '\n<source src="' + e.source2 + '"' + (e.source2mime ? ' type="' + e.source2mime + '"' : "") + " />\n" : "") + "</audio></figure>"
        }(n, o) : "script" === n.type ? function(e) {
            return '<script src="' + e.source1 + '"><\/script>'
        }(n) : function(e, t) {
            // Custom change: added <figure> element with the post__video class
            return t ? t(e) : '<figure class="post__video"><video width="' + e.width + '" height="' + e.height + '"' + (e.poster ? ' poster="' + e.poster + '"' : "") + ' controls="controls">\n<source src="' + e.source1 + '"' + (e.source1mime ? ' type="' + e.source1mime + '"' : "") + " />\n" + (e.source2 ? '<source src="' + e.source2 + '"' + (e.source2mime ? ' type="' + e.source2mime + '"' : "") + " />\n" : "") + "</video></figure>"
        }(n, a)
    }
    ...
    var $, z = function(r) {
        ...
        fe = [{
            ...
            w: 560,
            h: 314,
            // Custom change: added "https:" prefix
        ...
        Oe = function(e, t, r) {
            var n, i, o, a, c;
            for (a = (o = t.attributes).length; a--;) n = o[a].name, i = o[a].value, "width" !== n && "height" !== n && "style" !== n && ("data" !== n && "src" !== n || (i = e.convertURL(i, n)), r.attr("data-mce-p-" + n, i));
            (c = t.firstChild && t.firstChild.value) && (r.attr("data-mce-html", escape(je(e, c))), r.firstChild = null)
        },
        Ae = function(i) {
            return function(e) {
                for (var t, r, n = e.length; n--;)(t = e[n]).parent && (t.parent.attr("data-mce-object") || "script" === t.name && !(r = v(J(i), t.attr("src"))) || (r && (r.width && t.attr("width", r.width.toString()), r.height && t.attr("height", r.height.toString())), "iframe" === t.name && V(i) && xe.ceFalse ? T(t) || t.replace(k(i, t)) : T(t) || t.replace(P(i, t))))
            }
        },
        Se = function(d) {
