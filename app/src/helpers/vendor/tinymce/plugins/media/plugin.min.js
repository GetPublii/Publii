 ...
 * 
 * Modified at 18th February 2022: unminified and modified to use figure elements with post__video/post__audio classes, disabled protocol-less URLs to videos 
 */
! function() {
    "use strict";
    ...
    function k(r, e) {
        ...
        return n.width = n.width || "300", n.height = n.height || "150", K.each(n, function(e, t) {
            n[t] = r.dom.encode("" + e)
        // Custom change: added <figure> element with the post__video class and added https when there is no protocol at the beginning, added <figure> element with the post__audio class, added <figure> element with the post__video class
        }), "iframe" === n.type ? (l = n.allowfullscreen ? ' allowFullscreen="1"' : "", '<figure class="post__video"><iframe src="' + (n.source.indexOf('//') === 0 ? 'https:' + n.source : n.source) + '" width="' + n.width + '" height="' + n.height + '"' + l + "></iframe></figure>") : "application/x-shockwave-flash" === n.sourcemime ? (u = '<object data="' + n.source + '" width="' + n.width + '" height="' + n.height + '" type="application/x-shockwave-flash">', n.poster && (u += '<img src="' + n.poster + '" width="' + n.width + '" height="' + n.height + '" />'), u + "</object>") : -1 !== n.sourcemime.indexOf("audio") ? (s = n, m ? m(s) : '<figure class="post__audio"><audio controls="controls" src="' + s.source + '">' + (s.altsource ? '\n<source src="' + s.altsource + '"' + (s.altsourcemime ? ' type="' + s.altsourcemime + '"' : "") + " />\n" : "") + "</audio></figure>") : "script" === n.type ? '<script src="' + n.source + '"><\/script>' : (c = n, d ? d(c) : '<figure class="post__video"><video width="' + c.width + '" height="' + c.height + '"' + (c.poster ? ' poster="' + c.poster + '"' : "") + ' controls="controls">\n<source src="' + c.source + '"' + (c.sourcemime ? ' type="' + c.sourcemime + '"' : "") + " />\n" + (c.altsource ? '<source src="' + c.altsource + '"' + (c.altsourcemime ? ' type="' + c.altsourcemime + '"' : "") + " />\n" : "") + "</video></figure>")
    }
