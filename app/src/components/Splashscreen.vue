...
export default {
    ...
    computed: {
        ...
        // Secondary and reopened windows go straight to the app - unless the license still has to be accepted
        isVisible () {
            return !this.$store.state.app.skipSplashScreen || !this.licenseAccepted;
        },
        version: function() {
